const data: {
  ...
  {
    description: `מדריך נהיגה מתקדמת ונהיגה ספורטיבית, במילואים בגזרה הצפונית מתחילת הלחימה והיד עוד נטויה :) בימים האחרונים הצלחתי להרים את העסק בין ריענון לריענון ואני שמח להזמין אתכם להצטרף אליי ללמוד איך לשלוט ברכב שלכם טוב יותר ולגלות את סודות הנהיגה (כל מה שלא לימדו אתכם בשיעורי הנהיגה) ההדרכות רלוונטיות לנהגים חדשים ולנהגים וותיקים כאחד, תמיד יש מה לשפר וללמוד איך לנהוג טוב יותר ולשמור על עצמנו בכבישים. בנוסף יש לנו עוד תחומים בספורט המוטורי שאנו עוסקים בהם, מוזמנים להיכנס לאתר שלנו וליצור איתי קשר, מחכה לכם :)`,
    title: "אביאל אמיר",
